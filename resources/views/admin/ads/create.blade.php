    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <div class="box box-primary">
                <!-- form start -->
                {!! Form::open(['url' => route('admin.ads.store'), 'method' => 'post', 'files' => true]) !!}
                {!! Form::hidden('image_url', '/statics/admin/img/user2-160x160.jpg') !!}
                    <div class="box-body">
                        <div class="form-group @if($errors->has('name')) has-error @endif">
                            {!! Form::label('name', '名称') !!}
                            {!! Form::text('name', old('name'), ['class' => 'form-control', 'placeholder' => '广告名称']) !!}
                            {!! $errors->first('name', show_error_html()) !!}
                        </div>
                        <div class="form-group @if($errors->has('instruction')) has-error @endif">
                            {!! Form::label('instruction', '描述') !!}
                            {!! Form::textarea('instruction', old('instruction'), ['class' => 'form-control', 'placeholder' => '广告描述']) !!}
                        ...
                        <div class="form-group @if($errors->has('platform')) has-error @endif">
                            ...
                            {!! Form::select('platform', $ad->platform_display, old('platform'), ['class' => 'form-control']) !!}
                        ...
                        <div class="form-group @if($errors->has('jump_type')) has-error @endif">
                            ...
                            {!! Form::select('jump_type', $ad->jump_type_display, old('jump_type'), ['class' => 'form-control']) !!}
                        ...
                        <div class="form-group @if($errors->has('app_id')) has-error @endif" style="display: block;" id="app_id_div">
                            ...
                            {!! Form::text('app_id', old('app_id'), ['class' => 'form-control', 'placeholder' => '小程序ID']) !!}
                        ...
                        <div class="form-group @if($errors->has('jump_url')) has-error @endif" style="display: none;" id="jump_url_div">
                            ...
                            {!! Form::text('jump_url', old('jump_url'), ['class' => 'form-control', 'placeholder' => '跳转链接']) !!}
                        ...
                        <div class="form-group @if($errors->has('ad_position_id')) has-error @endif">
                            ...
                            {!! Form::text('ad_position_id', old('ad_position_id'), ['class' => 'form-control', 'placeholder' => '广告位ID']) !!}
                        ...
                        <div class="form-group @if($errors->has('start_at')) has-error @endif">
                            ...
                            {!! Form::text('start_at', old('start_at'), ['class' => 'form-control', 'placeholder' => '开始时间：时间格式为Y-m-d H:i:s']) !!}
                            {!! $errors->first('start_at', show_error_html()) !!}
                        </div>
                        <div class="form-group @if($errors->has('end_at')) has-error @endif">
                            {!! Form::label('end_at', '结束时间') !!}
                            {!! Form::text('end_at', old('end_at'), ['class' => 'form-control', 'placeholder' => '结束时间：时间格式为Y-m-d H:i:s']) !!}
                        ...
                        <div class="form-group @if($errors->has('status')) has-error @endif">
                            ...
                            {!! Form::select('status', $ad->status_display, old('status'), ['class' => 'form-control']) !!}
